 ...
 */
final class Version20201121084356 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE route ADD CONSTRAINT FK_2C420791FEA67AA FOREIGN KEY (place_in_id_id) REFERENCES place (id)');
